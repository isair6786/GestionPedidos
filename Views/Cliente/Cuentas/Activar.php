...
<div  class="card shadow mb-4 col-sm-12">
        ...
        <?php 
            ...
            if(isset($_GET["Id"])){
                ...
                $EliminarCuenta = ControladorCuentas::ActivarCuenta($_GET["Id"]);

                    if($EliminarCuenta){
                        echo "<script>
                            LanzarModal('success','Cuenta Activada','Cuenta Activada Correctamente')

                         </script>";
                    }else{
                        echo "<script>LanzarModal('Error','Cuenta no Activada','')</script>";
                    }
                }else{
                    echo "<script>LanzarModal('Error','Cuenta no Activada','')</script>";
                }
