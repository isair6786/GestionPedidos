...
<a class="btn btn-primary mb-2" href="Login.php?Pagina=Dashboard&Modulo=Pedidos&Accion=Cobrar" role="button">
  <i class="fas fa-plus-circle"></i> Cobrar Todos los Pedidos  
</a>
